...
export type FileFieldsEnum = 
  ...
  | 'childMarkdownRemark___frontmatter___heroBannerSection___aboutMe'
...
export type MarkdownRemarkFieldsEnum = 
  ...
  | 'frontmatter___heroBannerSection___aboutMe'
...
export type AboutPageQuery = { markdownRemark?: Maybe<{ frontmatter?: Maybe<{ SEO?: Maybe<Pick<MarkdownRemarkFrontmatterSeo, 'title'>>, heroBannerSection?: Maybe<Pick<MarkdownRemarkFrontmatterHeroBannerSection, 'role' | 'greeting' | 'aboutMe'>>, servicesSection?: Maybe<(
...
export type BlogPageQuery = { markdownRemark?: Maybe<{ frontmatter?: Maybe<Pick<Frontmatter, 'title' | 'subtitle'>> }>, allMarkdownRemark: { edges: Array<{ node: (
